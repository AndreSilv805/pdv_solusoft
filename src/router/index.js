...
const ProdutoDetalhes = () => import(/* webpackChunkName: "produtos" */ '@/views/produtos/ProdutoDetalhes.vue')
...
const ClienteDetalhes = () => import(/* webpackChunkName: "produtos" */ '@/views/clientes/ClienteDetalhes.vue')
...
const routes = [
  ...
  ////rotas produtos  
  { 
    path: '/produtos', component: Produtos, alias: ['/meus-contatos', '/lista-de-contatos'],
    props: (route) => {
    ...
    children: [
      ...
      { path: ':id(\\d+)', component: ProdutoDetalhes, name: 'produto', props: extrairParametroId,
      }, // produtos.com/contatos/2
      ...
      { path: ':id(\\d+)/editar', alias: ':id(\\d+)/alterar', 
        ...
        props: {
          ...
          'produto-detalhes': extrairParametroId
        },
  ...
  ///rotas clientes
  { 
    path: '/clientes', component: Clientes, alias: ['/meus-contatos', '/lista-de-contatos'],
    props: (route) => {
      const busca = route.query.busca
      return busca ? { busca } : {}
    },
    ...
    children: [
      { path: ':id(\\d+)', component: ClienteDetalhes, name: 'cliente', props: extrairParametroId,
      }, // produtos.com/contatos/2
      ...
      { path: ':id(\\d+)/editar', alias: ':id(\\d+)/alterar', 
        ...
        props: {
          default: extrairParametroId,
          'cliente-detalhes': extrairParametroId
        },
      }, // produtos.com/contatos/2/editar
  ...
  ///rotas pedidos
  { 
    path: '/pedidos', component: Pedidos, alias: ['/meus-contatos', '/lista-de-contatos'],
    props: (route) => {
      const busca = route.query.busca
      return busca ? { busca } : {}
    },
